...
model_file_path = '/home/opencpu/test2/model/cmccm_3group.rda'
csv_data_path = '~/cmccm_3group.csv'
buildmodel = function(csv_data_path){
  ...
  # 人群分类
  data_model[,"group"] = ifelse(data_model[,"group"]==1,0,ifelse(data_model[,"group"]==2,1,2))
